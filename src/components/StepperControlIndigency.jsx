...
const StepperControlIndigency = ({ handleClick, currentStep, steps, uploadIDFieldsComplete, personalInfoFieldsComplete, indigencyAddressFieldsComplete, paymentFieldsComplete}) => {
  ...
  const isNextButtonDisabled = () => {
    ...
    return !indigencyAddressFieldsComplete;
