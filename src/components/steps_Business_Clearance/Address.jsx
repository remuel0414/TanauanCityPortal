...
export default function Address({handleAddressInfoFieldsComplete , passInputDataToParent}) {
  ...
  useEffect(() => {
    const requiredFields = ["house-bldg-number", "building-name", "lot-number", "subdivision", "street", "region", "province", "city", "barangay"];
    const isComplete = requiredFields.every(field => !!userData[field]);
    handleAddressInfoFieldsComplete(isComplete);
  }, [userData, handleAddressInfoFieldsComplete]);
