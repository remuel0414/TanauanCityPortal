...
const StepperControlCommunity = ({ handleClick, currentStep, steps, eventDetailsFieldsComplete, organizerInformationFieldsComplete, participantInformationFieldsComplete, uploadIDFieldsComplete, paymentFieldsComplete}) => {

  const isNextButtonDisabled = () => {
    if (currentStep === 1) {
        return !eventDetailsFieldsComplete;
    }else if(currentStep === 2){
        return !organizerInformationFieldsComplete;
    }else if(currentStep === 3){
        return !participantInformationFieldsComplete;
