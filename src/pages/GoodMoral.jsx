...
function GoodMoralPage({numberOfCopies}) {
    ...
    const displayStep = (step)=>{
        switch (step){
            case 1: 
                return <PersonalInfo handlePersonalInfoFieldsComplete= {handlePersonalInfoFieldsComplete} passInputDataToParent={passInputDataToParent} passIdToParent={handleUploadedIdFiles}/>
            case 2: 
